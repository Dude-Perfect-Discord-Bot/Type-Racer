...
client.on(Events.MESSAGE_CREATE, async (message) => {
	...
	if (message.channel.id === "799727227041611776" && (!message.member.permissions.has('BAN_MEMBERS') || message.author.id !== "259008949427119891")) return message.channel.send("You don't have perms to use this command here!");
